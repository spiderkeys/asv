...
class MavchannelConan(ConanFile):
    ...
    requires        =   ( 
                            ( "readerwriterqueue/1.0.1@missionrobotics/stable" ),
                            ( "concurrentqueue/1.0.0@missionrobotics/stable" ),
                            ( "serial/1.2.1@missionrobotics/stable" ),
                            ( "mavlink2/1.0.0@missionrobotics/stable" )
                        )
